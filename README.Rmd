...
Full genome-wide LD files are not bundled with the package. Users must supply
a compatible, ancestry-matched external LD reference in the documented input
format; see the *Computing the LD-Corrected Gene-Level Response* vignette.
